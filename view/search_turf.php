...
<div class="glass-card">
    <div style="display:flex; justify-content:space-between; align-items:center; gap:15px; flex-wrap:wrap; margin-bottom:20px;">
        <h2 style="margin:0;">Available Turfs</h2>

        <form method="GET" action="" style="display:flex; gap:10px; width:100%; max-width:950px; align-items:center;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 20px;">
        <?php if ($result->num_rows > 0): ?>
                ...
                <div class="glass-card" style="background: rgba(255, 255, 255, 0.05); padding: 15px; position: relative;">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 15px; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 15px;">
                        <div>
                            ...
                            <span style="font-size: 22px; font-weight: bold; color: #2ecc71;">
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <div class="glass-card" style="padding:20px; opacity:0.85;">
                No turfs found<?php echo !empty($search_query) ? " for <strong>".htmlspecialchars($search_query)."</strong>" : ""; ?>.
            </div>
        <?php endif; ?>
    </div>
</div>
